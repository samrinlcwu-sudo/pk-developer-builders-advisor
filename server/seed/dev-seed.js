...
function seed() {
  ...
  const demoArticles = [
    {
      title: "[DEMO] A First-Time Buyer's Guide to Property Types",
    ...
    {
      title: "[DEMO] Key Factors to Weigh Before a Property Investment",
      category: "investment",
    ...
    {
      title: "[DEMO] What Happens During Each Phase of Construction",
    ...
    {
      title: "[DEMO] How Mixed-Use Developments Get Planned",
    ...
    {
      title: "[DEMO] How to Read Local Property Market Signals",
    ...
    {
      title: "[DEMO] A Step-by-Step Guide to the Property Buying Process",
      category: "guides",
    ...
    {
      title: "[DEMO] A Practical Checklist for Property Documentation",
      category: "guides",
  ...
  for (const a of demoArticles) {
    ...
    console.log("[seed] Created demo article #%d: %s", article.id, article.title);
  }
